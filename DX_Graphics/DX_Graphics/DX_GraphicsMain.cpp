...
DX_GraphicsMain::DX_GraphicsMain(const std::shared_ptr<DX::DeviceResources>& deviceResources) :
...
DX_GraphicsMain::~DX_GraphicsMain()
{
...
void DX_GraphicsMain::CreateWindowSizeDependentResources() 
{
...
void DX_GraphicsMain::OnDeviceLost()
{
...
void DX_GraphicsMain::OnDeviceRestored()
{
